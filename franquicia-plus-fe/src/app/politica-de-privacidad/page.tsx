const PrivacyPolicy = () => {
  return (
    <>
      <div className="h-full w-full flex justify-center pt-5 px-28">
        <div className="w-full">
          <h1 className="font-bold text-blue-600 text-2xl mb-4">
            POLÍTICA DE PRIVACIDAD
          </h1>
          <p className="mb-4">
            Establece los términos en que Franquicia Plus usa y protege la
            información que es proporcionada por sus usuarios al momento de
            utilizar su sitio. La compañía está comprometida con la seguridad de
            los datos de sus usuarios. Cuando le pedimos llenar los campos de
            información personal con los cuales usted pueda ser identificado, lo
            hacemos asegurando que solo se empleará de acuerdo con los términos
            de este documento. Sin embargo, esta Política de Privacidad puede
            cambiar con el tiempo o ser actualizada, por lo que le recomendamos
            y enfatizamos revisar continuamente esta página para asegurarse de
            que está de acuerdo con dichos cambios.
          </p>
          <h2 className="font-bold text-lg">Información que es recogida</h2>
          <p className="mb-4">
          ...
          <h2 className="font-bold text-lg">Uso de la información recogida</h2>
          <p className="mb-1">
          ...
          <p className="mb-4">
            Franquicia Plus está altamente comprometido para cumplir con el
            compromiso de mantener su información segura. Usamos los sistemas
            más avanzados y los actualizamos constantemente para asegurarnos de
          ...
          <p className="mb-4">
            ...
            estas no dan acceso a información de su ordenador ni de usted, a
          ...
          <h2 className="font-bold text-lg">Enlaces a Terceros</h2>
          <p className="mb-4">
          ...
          <p className="mb-1">
            Franquicia Plus se reserva el derecho de cambiar los términos de la
